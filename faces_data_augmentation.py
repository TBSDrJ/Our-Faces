...
# Repeat versions of the next two lines as many times as needed/desired.
# Check out https://www.tensorflow.org/api_docs/python/tf/image#functions
#   for a long list of potential transformations
train_flipped = train.map(lambda x, y: (image.flip_left_right(x), y))
train = train.concatenate(train_flipped)
